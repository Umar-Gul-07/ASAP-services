...
export default function SellerProfile() {
  ...
  const fetchBuyerData = async () => {
    if (!userId) return;
    try {
      const res = await axios.get(`https://asap-nine-pi.vercel.app/getseller/${userId}`, {
        headers: {
          Authorization: token,
        },
      });
    ...
    reader.onloadend = async () => {
      ...
      try {
        ...
        const res = await axios.post(
          'https://asap-nine-pi.vercel.app/seller/update',
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.post(
        'https://asap-nine-pi.vercel.app/seller-update-profile',
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 bg-gray-50 p-8 overflow-auto">
          ...
          <section className="bg-white rounded-lg shadow p-6 max-w-4xl mx-auto">
            <h2 className="font-bold text-lg mb-3">Seller Profile</h2>
